...
val don't_wait_for : here:[%call_pos] -> (unit -> unit Deferred.t) -> unit
...
val assert_foreground : ?message:Sexp.t -> here:[%call_pos] -> unit -> unit
...
module Private : sig
  val mark_running_in_background : here:[%call_pos] -> (unit -> 'a) -> 'a
