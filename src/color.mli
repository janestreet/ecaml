...
val is_gray : ?on:Frame.t (** default is selected frame *) -> t -> bool

(** [(describe-function 'color-defined-p)] *)
val is_defined : ?on:Frame.t (** default is selected frame *) -> t -> bool

(** [(describe-function 'color-supported-p)] *)
val is_supported : ?on:Frame.t (** default is selected frame *) -> t -> bool
